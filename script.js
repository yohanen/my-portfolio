// Theme toggle function is now handled inline in index.html
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Nav link click handler (single handler, no redundancy)
  ...
  // Hamburger menu for mobile (fixed to use correct IDs)
